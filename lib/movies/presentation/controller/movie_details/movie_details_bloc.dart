...
class MovieDetailsBloc extends Bloc<MovieDetailsEvent, MovieDetailsState> {
  MovieDetailsBloc(this.getMovieDetailsUseCase, this.getRecommendationUseCase,
      this.addFavoriteMoviesUseCase, this.deleteFavoriteMoviesUseCase)
  ...
  FutureOr<void> _addFavoriteMovies(AddFavoriteMoviesEvent event, Emitter<MovieDetailsState> emit) async {
