...
class _FavoriteMoviesScreenState extends State<FavoriteMoviesScreen> {
    ...
    return BlocBuilder<FavoriteMoviesCubit, FavoriteMoviesState>(
        builder: (context, state) {
          return FavoriteMoviesCubit.get(context).favoriteMoviesList.isNotEmpty
              ? GridView.builder(
            itemCount:
            FavoriteMoviesCubit.get(context).favoriteMoviesList.length,
            ...
            itemBuilder: (BuildContext context, int index) {
              return _buildItemCardWidget(
                FavoriteMoviesCubit.get(context).favoriteMoviesList[index],
                    () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (BuildContext context) => MovieDetailScreen(
                          movie: Movie(
                            id: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .idMovieModel,
                            title: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .title,
                            backdropPath: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .backdropPath,
                            overview: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .overview,
                            releaseDate: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .releaseDate,
                            voteAverage: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .voteAverage,
                            genreIds: FavoriteMoviesCubit.get(context)
                                .favoriteMoviesList[index]
                                .genreIds,
                          )),
                    ),
  ...
  Widget _buildItemCardWidget(MovieModelDB movie, Function()? onTap) {
    return Container(
      width: 120.0,
